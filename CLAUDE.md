...
13. **Roadmap** : realise dans `docs/ROADMAP_DONE.md` ; a venir reparti par **sprint** dans `docs/roadmap/` :
   ...
   - Plans annexes : `PLAN_RETENTION.md` (**RET-01→07 ✅ complet** — retention hebdomadaire), `PLAN_SETTLEMENTS.md` (**FOY-01→17 ✅ complet** — pilier territorial : foyers, ce que le rang ouvre, la Crue et la vassalite, la chronique au journal de monde, la Paleur des filons, sa restauration payee au tresor, les ateliers de doctrine, les marees declenchees et le contrat de test transverse ; adosse a `docs/GAME_WORLD.md`), `PLAN_ZONES.md` (**ZON-30→36, 5/7** — contenu des zones du jeu de base ; **ZON-30** : les Vallons d'Aubepine, la zone-ecole du depeceur ; **ZON-31** : les Dunes d'Ambre approfondies, l'ambre devient une matiere ; **ZON-32** : les signatures d'amethyste par zone entrent dans le tirage ; **ZON-34** : la ligne du bois, cinquieme recolte (recettes livrees par ECO-30) ; **ZON-35** : les recoltes harmonisees, plus une matiere sans debouche ni sans source ; decline `docs/GAME_ZONES.md`), `PLAN_FACTIONS.md` (**FAC-01→10, 0/10** — tension par paires, patronage, la Fonderie, les Ruelles, les cinq portes ; decline GAME_WORLD §6.4 et §12.2/12.4/12.5), `PLAN_DOMAINS.md` (**DOM-01→08, 0/8** — passifs types element×registre, equipement-build, specialisations, arbres neufs ; decline `docs/GAME_DOMAINS.md`), `PLAN_GUILD_CITY_CONTROL.md` (GCC-01→20 ✅), `PLAN_NARRATIVE.md` (NAR-01→14 ✅ ; **vague 2 ouverte** : NAR-15→19, l'an 1 des marees — decline `docs/GAME_SEASONS.md`), `PLAN_TESTING.md` (TST-01→15 ✅), `PLAN_PLAYER_ECONOMY.md` (Pistes A/B/C/D/E **completes** ; **Piste G complete** — chaine de production par paliers, purete propagee, aucun craft destructeur de valeur ; Piste F 3/4 ; **Piste H complete** — les trois metiers manquants ; **ECO-29** : le cuisinier, sept poissons cessent d'etre orphelins ; **ECO-30** : le charpentier, quatre essences cessent d'etre orphelines ; **ECO-31** : le tailleur, les mages cessent de s'habiller en cuir)
