...
- [docs/GAME_ONBOARDING.md](docs/GAME_ONBOARDING.md) — **Cadrage de l'entree dans le jeu** (source de verite du compte, du personnage et des dix premieres minutes) : l'inscription avec **verification d'e-mail differee** (elle ne barre pas le jeu, elle barre le marche, les guildes, le chat et la livraison aux foyers — donc le multicomptage), le **tunnel unique en 4 pas** (compte → nom → peuple → visage) porte par une seule fiction, le **peuple qui porte le foyer d'attache** (GAME_WORLD §13.1) sans jamais ouvrir ni fermer de contenu — sa seule vraie fonction est de **filtrer les 32 arbres a 3**, le nouvel ordre du tutoriel (recolte d'abord, **materia en 4e**, voyage en dernier parce qu'il fait attendre), le **coach par ecran** (un ecran jamais ouvert se presente une fois, dit ce que ca coute, et ne parle jamais d'un systeme inutilisable) et les 10 dettes constatees dans le code. Premier ecran apres creation : **la zone, jamais le hub**. Decline en ONB-01→15
