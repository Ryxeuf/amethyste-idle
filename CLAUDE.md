...
13. **Roadmap** : realise dans `docs/ROADMAP_DONE.md` ; a venir reparti par **sprint** dans `docs/roadmap/` :
   ...
   - Plans annexes : `PLAN_SETTLEMENTS.md` (**FOY-01→16, 0/16 — prochain grand chantier** : foyers, Crue, Paleur ; adosse a `docs/GAME_WORLD.md`), `PLAN_GUILD_CITY_CONTROL.md` (GCC-01→20 ✅), `PLAN_NARRATIVE.md` (NAR-01→14 ✅), `PLAN_TESTING.md` (TST-01→15 ✅), `PLAN_PLAYER_ECONOMY.md` (Pistes A/B **completes** au Sprint 14 ; Piste C en cours au Sprint 15)
