...
- [docs/GAME_WORLD.md](docs/GAME_WORLD.md) — **Socle de monde** (proposition) : geographie, civilisation, politique, trame globale. Postulat unique (le temps vecu se depose en amethystite) d'ou decoulent les biomes (un biome = une facon dont le temps s'est depose), les **foyers** (nœuds a la Ashes of Creation, sans siege : l'activite des joueurs fait monter Campement → Metropole, l'inactivite fait redescendre) et la **Crue** (quota dur de grandes cites = enjeu de territoire sans PvP), l'economie territoriale a la Albion (une ligne de production par biome, bonus d'atelier par foyer, caravanes PvE), la politique (la Concorde, le Serment = raison interne du « pas de PvP », axe Extraire/Preserver, faction **la Fonderie** a creer) et le scenario (acte d'intro / marees / meta-arc du Reflux). A lire **avant** d'ajouter une zone, une faction ou un theme de saison
