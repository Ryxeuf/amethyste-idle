...
class Guild
{
    ...
    #[ORM\OneToMany(targetEntity: GuildMember::class, mappedBy: 'guild', cascade: ['remove'])]
    ...
    public function addMember(GuildMember $member): void
    {
    ...
    public function removeMember(GuildMember $member): void
    {
