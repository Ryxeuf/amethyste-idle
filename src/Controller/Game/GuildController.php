...
class GuildController extends AbstractController
{
    ...
    public function taxUpdate(string $regionSlug, Request $request): JsonResponse
    {
        ...
        if ($ratePercent < 1 || $ratePercent > \App\Entity\App\Region::MAX_TAX_RATE_PERCENT) {
            return new JsonResponse(['error' => sprintf('Le taux de taxe doit etre entre 1%% et %d%%.', \App\Entity\App\Region::MAX_TAX_RATE_PERCENT)], Response::HTTP_BAD_REQUEST);
        }
