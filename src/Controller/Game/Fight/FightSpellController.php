...
class FightSpellController extends AbstractController
{
    ...
    public function __invoke(Request $request): Response
    {
        ...
        // Apply linked materia bonus (+15% damage if linked slots share element)
        if ($linkedBonus) {
            $bonuses['damage'] += (int) round($bonuses['damage'] * LinkedMateriaResolver::LINKED_MATERIA_DAMAGE_BONUS);
        }
