...
class MobFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $mobs = [
            ...
            // materialisees par `ZoneImporter`. Les garder aussi ici les
            // dupliquait : la fixture de zone tourne avant celle-ci (cf.
            // `getDependencies`), l'import creait l'effectif declare, puis ces
            // entrees en rajoutaient un second par la carte TMX.
