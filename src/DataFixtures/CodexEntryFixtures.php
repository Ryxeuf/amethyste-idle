...
class CodexEntryFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        $entries = [
            ...
            // FAC-04b — ce que la lecture inscrit. Une page par flux : la
            // premiere materia lue de chaque element ouvre la sienne. C'est le
            // versant durable du choix fondre/lire — la fonte n'ouvre jamais
            // rien ici (GAME_WORLD § 12.2 : « le Codex n'avance pas »).
            [
                'slug' => 'lecture-du-feu',
                'category' => CodexEntry::CATEGORY_WORLD_FACT,
                'title' => 'Lecture : le flux du feu',
                'title_translations' => ['en' => 'Reading: the flow of fire'],
                'description' => "La materia de feu retient des étés entiers : moissons brûlantes, forges, colères. La lire, c'est rendre au monde un peu de sa chaleur déposée — au lieu de la brûler une seconde fois.",
                'description_translations' => ['en' => 'Fire materia holds whole summers: scorching harvests, forges, tempers. Reading it returns some of that deposited warmth to the world — instead of burning it twice.'],
                'unlockType' => CodexEntry::UNLOCK_MATERIA_READ,
                'unlockKey' => 'fire',
            ],
            [
                'slug' => 'lecture-de-l-eau',
                'category' => CodexEntry::CATEGORY_WORLD_FACT,
                'title' => "Lecture : le flux de l'eau",
                'title_translations' => ['en' => 'Reading: the flow of water'],
                'description' => "L'eau dépose lentement, et n'oublie rien : crues, pluies patientes, larmes peut-être. Chaque lecture retrouve un rythme que la fonte aurait dispersé en vapeur.",
                'description_translations' => ['en' => 'Water deposits slowly, and forgets nothing: floods, patient rains, perhaps tears. Each reading recovers a rhythm the foundry would have scattered as steam.'],
                'unlockType' => CodexEntry::UNLOCK_MATERIA_READ,
                'unlockKey' => 'water',
            ],
            [
                'slug' => 'lecture-de-la-terre',
                'category' => CodexEntry::CATEGORY_WORLD_FACT,
                'title' => 'Lecture : le flux de la terre',
                'title_translations' => ['en' => 'Reading: the flow of earth'],
                'description' => "La terre est le plus ancien des dépôts : elle retient les fondations, les tombes et les racines. Sa lecture est lente, disent les Lecteurs — comme tout ce qui tient.",
                'description_translations' => ['en' => 'Earth is the oldest of deposits: it holds foundations, graves and roots. Its reading is slow, the Readers say — like everything that lasts.'],
                'unlockType' => CodexEntry::UNLOCK_MATERIA_READ,
                'unlockKey' => 'earth',
            ],
            [
                'slug' => 'lecture-de-l-air',
                'category' => CodexEntry::CATEGORY_WORLD_FACT,
                'title' => "Lecture : le flux de l'air",
                'title_translations' => ['en' => 'Reading: the flow of air'],
                'description' => "L'air dépose peu, et partout : voyages, cris, chansons portées d'un village à l'autre. Une materia d'air lue rend des routes que personne n'avait cartographiées.",
                'description_translations' => ['en' => 'Air deposits little, and everywhere: journeys, cries, songs carried from village to village. A read air materia returns roads no one had ever mapped.'],
                'unlockType' => CodexEntry::UNLOCK_MATERIA_READ,
                'unlockKey' => 'air',
            ],
            [
                'slug' => 'lecture-de-la-lumiere',
                'category' => CodexEntry::CATEGORY_WORLD_FACT,
                'title' => 'Lecture : le flux de la lumière',
                'title_translations' => ['en' => 'Reading: the flow of light'],
                'description' => "Ce que la lumière dépose, ce sont les veilles : les feux tenus, les gardes montées, les promesses tenues jusqu'au matin. Le Fanal en est couvert.",
                'description_translations' => ['en' => 'What light deposits are the vigils: fires kept, watches stood, promises held until morning. The Beacon is covered in them.'],
                'unlockType' => CodexEntry::UNLOCK_MATERIA_READ,
                'unlockKey' => 'light',
            ],
            [
                'slug' => 'lecture-de-l-ombre',
                'category' => CodexEntry::CATEGORY_WORLD_FACT,
                'title' => "Lecture : le flux de l'ombre",
                'title_translations' => ['en' => 'Reading: the flow of shadow'],
                'description' => "L'ombre retient ce qu'on a voulu taire. Les Lecteurs la lisent avec des gants, et n'en publient pas tout — c'est la seule lecture dont le Cercle garde une part.",
                'description_translations' => ['en' => 'Shadow holds what was meant to stay unsaid. The Readers handle it with gloves, and do not publish all of it — the only reading the Circle keeps a share of.'],
                'unlockType' => CodexEntry::UNLOCK_MATERIA_READ,
                'unlockKey' => 'dark',
            ],
            [
                'slug' => 'lecture-du-metal',
                'category' => CodexEntry::CATEGORY_WORLD_FACT,
                'title' => 'Lecture : le flux du métal',
                'title_translations' => ['en' => 'Reading: the flow of metal'],
                'description' => "Le métal dépose le travail : chaque coup de marteau, chaque lame affûtée, chaque essieu qui a tenu. La Fonderie dit que c'est le flux le plus honnête. Les Lecteurs répondent que c'est pour ça qu'elle le brûle en premier.",
                'description_translations' => ['en' => "Metal deposits labour: every hammer blow, every sharpened blade, every axle that held. The Foundry calls it the most honest flow. The Readers answer that this is why it burns it first."],
                'unlockType' => CodexEntry::UNLOCK_MATERIA_READ,
                'unlockKey' => 'metal',
            ],
            [
                'slug' => 'lecture-de-la-bete',
                'category' => CodexEntry::CATEGORY_WORLD_FACT,
                'title' => 'Lecture : le flux de la bête',
                'title_translations' => ['en' => 'Reading: the flow of beast'],
                'description' => "Les bêtes ne se souviennent pas — c'est le monde qui se souvient d'elles. Migrations, meutes, hivernages : la materia de bête est un almanach que personne n'a écrit.",
                'description_translations' => ['en' => 'Beasts do not remember — the world remembers them. Migrations, packs, winterings: beast materia is an almanac no one wrote.'],
                'unlockType' => CodexEntry::UNLOCK_MATERIA_READ,
                'unlockKey' => 'beast',
            ],
        ];
