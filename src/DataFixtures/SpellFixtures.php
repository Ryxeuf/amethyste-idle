...
class SpellFixtures extends Fixture
{
    ...
    private function getSpellsData(): array
    {
        return [
            ...
            // === Sorts de consommables (potions, nourritures, parchemins) ===

            // Potions de soin
            'potion_heal_minor' => [
                'slug' => 'potion-heal-minor',
                'damage' => null,
                'element' => Element::None,
                'heal' => 5,
                'name' => 'Soin mineur',
            ...
            'potion_energy_restore' => [
                'slug' => 'potion-energy-restore',
                'damage' => null,
                'element' => Element::None,
                'heal' => null,
                'name' => 'Restauration de mana',
                'description' => 'Restaure de l\'énergie magique',
                'hit' => 100,
                'level' => 1,
            ],
            'potion_antidote' => [
                'slug' => 'potion-antidote',
                'damage' => null,
                'element' => Element::Light,
                'heal' => 3,
                'name' => 'Antidote',
                'description' => 'Purifie le corps des poisons et venins',
                'hit' => 100,
                'level' => 1,
            ],
            ...
            'food_bread' => [
                ...
                'description' => 'Un pain frais qui rassasie et revigore',
                'hit' => 100,
                'statusEffectSlug' => 'food-buff',
                'level' => 1,
            ],
            'food_grilled_meat' => [
                'slug' => 'food-grilled-meat',
                'damage' => null,
                'element' => Element::None,
                'heal' => 5,
                'name' => 'Viande grillée',
                'description' => 'Une viande grillée savoureuse qui renforce le corps',
                'hit' => 100,
                'statusEffectSlug' => 'food-buff',
                'level' => 1,
            ],
            'food_stew' => [
                ...
                'heal' => 8,
                'name' => 'Ragoût copieux',
                'description' => 'Un ragoût roboratif qui soigne et régénère',
                'hit' => 100,
                'statusEffectSlug' => 'natural-regen',
                'level' => 1,
            ],
        ];
    }
