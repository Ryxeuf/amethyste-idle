...
> Derniere mise a jour : 2026-04-21 (135 — Localisation i18n sous-phase 2b : audit des cles utilisees mais absentes)
...
- [x] Verification : 438 cles FR = 438 cles EN (parite maintenue). `php scripts/audit-translations.php --active-only` sort 0 cle manquante.
