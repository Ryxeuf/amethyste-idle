...
> **PIVOT PBBG (juillet 2026)** : abandon de la carte en tuiles, le monde est un graphe de zones
> (energie, time-gating reel). Voir [PIVOT_PBBG.md](PIVOT_PBBG.md) et le bilan de campagne
> [ZON_CAMPAIGN_RECAP.md](ZON_CAMPAIGN_RECAP.md).

Les taches **todo** sont reparties par sprint dans `docs/roadmap/` :

- **Index (legende + ordre de chantier + graphe + liens) :** [roadmap/ROADMAP_TODO_INDEX.md](roadmap/ROADMAP_TODO_INDEX.md)
- **Vagues 1 a 6 :** ✅ Terminees (100 taches + 16 MED + 20 GCC)
- **Sprints 1 a 6 :** ✅ Termines (coeur de jeu)
- **Sprints 7 a 10 :** ✅ Termines (campagne ZON-01→21, pivot PBBG complet)
- **Sprints 11, 13, 14, 15 :** ✅ Termines — [Sprint 11](roadmap/SPRINT_11.md) 6/6, [Sprint 13](roadmap/SPRINT_13.md) 8/8, [Sprint 14](roadmap/SPRINT_14.md) 9/9, [Sprint 15](roadmap/SPRINT_15.md) 8/8
...
- [roadmap/PLAN_AVATAR_SYSTEM.md](roadmap/PLAN_AVATAR_SYSTEM.md) — ⛔ clos par le pivot PBBG (34/38 realisees)
- [roadmap/ARCHIVE_SPRINT_11_12.md](roadmap/ARCHIVE_SPRINT_11_12.md) — archive du detail livre des Sprints 11-12
