...
> Avancement : sous-phases 1, 2a et 2b livrees (page `/game/rankings` + onglets kills / quetes / XP totale). Sous-phases 3 (saisonnalite) et 4 (recompenses) restent a faire.
