...
> Avancement : sous-phases 1, 2a, 2b et 3 livrees (page `/game/rankings` + onglets kills / quetes / XP totale + archivage a la fin de saison). Sous-phase 4 (recompenses) reste a faire.
