...
> Avancement : sous-phases 1, 2a, 2b, 3, 4a, 4b.1, 4b.1b et 4b.1c livrees (page `/game/rankings` + onglets kills / quetes / XP totale + archivage a la fin de saison + titres de podium top-3 + affichage des titres du joueur sur la page classement et le profil public + Hall of Fame `/game/rankings/history` listant les podiums des saisons archivees). Sous-phase 4b.2 (cosmetiques + items exclusifs) reste a faire.
...
- [~] Recompenses avancees : cosmetiques, items exclusifs, affichage des titres — sous-phase 4b
  ...
  - [ ] Recompenses cosmetiques / items exclusifs (sous-phase 4b.2)
