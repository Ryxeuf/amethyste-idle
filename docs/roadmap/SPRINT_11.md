...
> Avancement : sous-phases 1, 2a, 2b, 3 et 4a livrees (page `/game/rankings` + onglets kills / quetes / XP totale + archivage a la fin de saison + titres de podium top-3). Sous-phase 4b (cosmetiques / items exclusifs + affichage des titres) reste a faire.
