...
> Avancement : sous-phases 1, 2a, 2b, 3, 4a et 4b.1 livrees (page `/game/rankings` + onglets kills / quetes / XP totale + archivage a la fin de saison + titres de podium top-3 + affichage des titres du joueur sur la page classement). Sous-phase 4b.2 (cosmetiques + items exclusifs) reste a faire.
