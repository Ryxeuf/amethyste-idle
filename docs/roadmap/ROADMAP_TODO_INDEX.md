...
> Derniere mise a jour : 2026-04-28 (135 sous-phase 3e.r — i18n complet de la page de soutien `/game/support` : 19 cles `game.support.*` FR/EN couvrant titre, header, description marketing, sections donation/communaute/que financent les dons, badge anti-P2W, footer transparence)
