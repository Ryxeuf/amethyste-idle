...
> Derniere mise a jour : 2026-04-28 (135 sous-phase 2i — i18n des notifications Mercure d'influence guilde `influence_notification_controller.js` : 7 cles `game.influence_notification.*` FR/EN, helper `_label`, labels passes via `stimulus_controller(...)`)
