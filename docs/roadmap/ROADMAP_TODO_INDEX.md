...
> Derniere mise a jour : 2026-04-28 (135 sous-phase 3e.u — i18n complet de la messagerie joueur `messages/{compose,inbox,read}.html.twig` : 19 cles uniques `game.messages.*` FR/EN couvrant les 3 templates avec partage de cles entre eux et conditionnel ternaire pour `Bloquer/Debloquer`)
