...
> Derniere mise a jour : 2026-04-28 (135 sous-phase 3e.p — i18n complet des 4 defis hebdomadaires de guilde : infra + cablage Twig + fixtures EN bout-en-bout)
...
| **Sprint 11** | Monde vivant | 6 | Basse | En cours (130 sous-phases 1 + 5 + 6, 131 sous-phases 2a + 3 + 4, 132 sous-phases 1 + 2a + 2b + 3 + 4a + 4b.1 + 4b.2, 133 sous-phases 1 + 1b) |
