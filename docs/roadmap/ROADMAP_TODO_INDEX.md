...
| Plan Archetypes (ARC-01→19) | 3/19 (+ ARC-03a) | **Ouvert le 2026-08-03** — ARC-01 (la fonction, 3e axe), **ARC-02** (le registre du geste + les premieres materia de technique, a+b) et **ARC-10** (plafond global supprime) livres ; **ARC-03a** (le vocabulaire des leviers) livre, **ARC-03b** (la formule) reste. Suite du noyau : ARC-03b puis **ARC-11** ; ARC-04 et ARC-11 sont debloques (← ARC-02), ARC-12 et ARC-15 le seront par ARC-03 |
