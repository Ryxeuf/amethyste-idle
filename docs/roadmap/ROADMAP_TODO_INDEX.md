...
| Plan Archetypes (ARC-01→19) | 8/19 (+ ARC-05a/b, ARC-06a, ARC-11a) | **Ouvert le 2026-08-03** — ARC-01 (la fonction, 3e axe), **ARC-02** (le registre du geste + les premieres materia de technique), **ARC-03** (les leviers : le vocabulaire puis la formule), **ARC-04** (une ressource par registre), **ARC-10** (plafond global supprime) et **ARC-05a/b** (les deux ancres : la duree d'un combat, puis la journee) livres. **Le noyau du modele est pose, et il est desormais mesurable des deux cotes** : reste **ARC-11** (intention, portee, loi du depot). **ARC-05c** (la recalibration des valeurs) est ouvert et attend **ARC-17**, le simulateur — le canon (§0.2) interdit de recalibrer a la main |
