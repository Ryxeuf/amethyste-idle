...
> Derniere mise a jour : 2026-04-28 (135 sous-phase 2h — i18n de la barre d'action rapide Stimulus `quickbar_controller.js` : 4 cles `game.quickbar.*` FR/EN, helper `_label`, labels passes via `stimulus_controller(...)`)
