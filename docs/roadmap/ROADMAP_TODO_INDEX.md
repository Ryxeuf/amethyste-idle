...
| Plan Archetypes (ARC-01→19) | 5/19 (+ ARC-05a) | **Ouvert le 2026-08-03** — ARC-01 (la fonction, 3e axe), **ARC-02** (le registre du geste + les premieres materia de technique), **ARC-03** (les leviers : le vocabulaire puis la formule) et **ARC-10** (plafond global supprime) livres. **Le noyau du modele est pose** : reste **ARC-11** (intention, portee, loi du depot). ARC-04, ARC-11, ARC-12 et ARC-15 sont debloques ; ARC-04 porte les 4 leviers encore sans consommateur |
...
> melee attend ARC-02) → **ARC ouvert le 2026-08-03 (ARC-01, ARC-02 et ARC-10 livres — le
> pont assume de DON est leve : les gestes d'arme du Soldat et de l'Archer sont des
> techniques)**, front actuel.
