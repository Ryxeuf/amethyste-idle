...
| Plan Onboarding (ONB-01→20) | 18/20 | Quasi complet — **ONB-02 livre le 2026-08-03** (mailer + mot de passe oublie, DSN prod a brancher par l'operateur) ; restent **ONB-04 (verification differee, second bloquant du playtest)** et ONB-07b |
...
> **ONB-02 ✅ (livre le 2026-08-03) puis ONB-04** (le mailer, bloquant du playtest — code d'abord, DSN ensuite) →
...
| 15 | **ONB-01 → 04** ◐ | Le compte peut naitre ([PLAN_ONBOARDING.md](PLAN_ONBOARDING.md), Piste A) | **ONB-01 et ONB-03 livres le 2026-07-29** (`/register` existe, `isBanned` est lu, la connexion mene la ou le joueur en est). **ONB-02 livre le 2026-08-03** (mailer Brevo + mot de passe oublie — le code est complet et teste, le DSN prod se branche quand compte + DNS sont prets). Reste **ONB-04** (verification differee, ← ONB-02 ✅) — perdre son mot de passe ne fait plus perdre son compte |
