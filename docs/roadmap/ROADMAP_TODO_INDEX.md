...
| Chantier Modele zone (ZON) | 16/21 | En cours (Sprint 7 ✅ + Sprint 8 ✅ ZON-07..12 + ZON-13..16 : expeditions, presence/chat, evenements, carte du monde illustree ; gel `map_frozen` activable en test) |
...
| **Sprint 9** | Time-gating, presence & evenements (ex-Avatar: Personnage & Equipement ✅ 8/8) | 4/5 | Haute | En cours (ZON-13..16 ✅) ← **Prochain : ZON-17** |
