...
> Derniere mise a jour : 2026-04-28 (135 sous-phase 2d — i18n du panneau Stimulus de recolte `harvest_controller.js` : 24 cles `game.harvest.*` FR/EN, helper `_label(key, fallback)`, labels passes via `stimulus_controller(...)`)
