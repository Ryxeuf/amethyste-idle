...
> Derniere mise a jour : 2026-04-26 (135 sous-phases 3c.s + 3c.r + 3e.c.statuseffect — 9 items iron tier + leather skins + 4 boss de zone Acte 2 + 3 items magiques + i18n complete des 15 effets de statut)
