...
| Chantier Modele zone (ZON) | 7/21 | En cours (Sprint 7 ✅ + ZON-07 ; gel `map_frozen` a activer apres Sprint 8) |
...
| **Sprint 8** | Energie & actions de zone (ex-Avatar: Backend & Carte ✅ 10/10) | 1/6 | Haute | En cours (ZON-07 ✅) ← **Prochain : ZON-08** |
