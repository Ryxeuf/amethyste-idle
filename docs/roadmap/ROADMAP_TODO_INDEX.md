...
> Derniere mise a jour : 2026-04-24 (134 sous-phase 2a — scenario k6 `metrics-stress` focalise sur `/metrics` pour isoler la latence de collecte Prometheus / Doctrine sous charge soutenue)
