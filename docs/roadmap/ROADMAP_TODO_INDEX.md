...
> Derniere mise a jour : 2026-04-28 (135 sous-phase 2g — i18n du panneau Stimulus de file de craft `craft_queue_controller.js` : 4 cles `game.crafting.queue.*` FR/EN, helper `_label`, labels passes via `stimulus_controller(...)`)
