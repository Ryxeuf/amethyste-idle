...
| Plan Archetypes (ARC-01→19) | 3/19 | **Ouvert le 2026-08-03** — ARC-01 (la fonction, 3e axe), **ARC-02** (le registre du geste + les premieres materia de technique, a+b) et **ARC-10** (plafond global supprime) livres. Suite du noyau : **ARC-03** (les leviers, L) puis **ARC-11** ; ARC-04 et ARC-11 sont desormais debloques (← ARC-02) |
