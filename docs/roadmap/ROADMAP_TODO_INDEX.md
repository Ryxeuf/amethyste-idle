...
> Derniere mise a jour : 2026-05-04 (135 sous-phase 3e.w.b — i18n du controller Stimulus chat `chat_controller.js` : 4 cles `game.chat.js.{send_error,deleted_message,private_outgoing,private_incoming}` FR/EN, helper defensif `_label(key, fallback)`, labels passes via `data-chat-labels-value` dans `templates/game/chat/index.html.twig`, parite maintenue 717=717)
