...
| 14 | **ZON-30 → 36** | Contenu des zones ([PLAN_ZONES.md](PLAN_ZONES.md)) | **6/7 livres au 2026-07-29** : ZON-30 (Vallons d'Aubepine), ZON-31 (Dunes approfondies), ZON-32 (signatures d'amethyste), ZON-34 (ligne du bois), ZON-35 (recoltes harmonisees — plus une matiere sans debouche ni sans source), ZON-36 (affinites elementaires — une regle et 23 corrections, pas une table). Reste ZON-33 (tests de conformite, en continu) |
