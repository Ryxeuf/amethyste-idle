...
> Derniere mise a jour : 2026-04-29 (135 sous-phase 3e.y — i18n complet de la page Services `/game/services` : 17 cles uniques `game.services.*` FR/EN couvrant transport rapide, reparation, renommage + cle de navigation `game.nav.services` utilisee dans le dropdown desktop et le drawer mobile)
