...
> Derniere mise a jour : 2026-04-28 (135 sous-phase 3e.v — i18n complet du centre de notifications : 7 cles `game.notifications.*` FR/EN couvrant page `/game/notifications` + fragment AJAX `_panel.html.twig` + dropdown trigger dans `game.html.twig`)
