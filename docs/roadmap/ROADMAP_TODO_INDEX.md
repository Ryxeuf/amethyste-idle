...
> Derniere mise a jour : 2026-04-28 (135 sous-phase 3e.t — i18n complet de la page de creation de personnage `character/create.html.twig` : 19 cles `game.character.create.*` FR/EN couvrant titre + formulaire + 4 stats `Vie/Energie/Vitesse/Precision`)
