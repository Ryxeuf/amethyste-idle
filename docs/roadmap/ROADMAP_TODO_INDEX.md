...
| Chantier Modele zone (ZON) | 14/21 | En cours (Sprint 7 ✅ + Sprint 8 ✅ ZON-07..12 + ZON-13 expeditions + ZON-14 presence/chat de zone ; gel `map_frozen` activable en test) |
...
| **Sprint 9** | Time-gating, presence & evenements (ex-Avatar: Personnage & Equipement ✅ 8/8) | 2/5 | Haute | En cours (ZON-13 ✅, ZON-14 ✅) |
