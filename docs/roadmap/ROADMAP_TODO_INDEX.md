...
> Derniere mise a jour : 2026-04-23 (135 — Localisation i18n sous-phase 3e.c.d.quest.e : cablage du filter `localized_quest_description` dans les templates du journal de quetes et du dashboard)
...
| **Sprint 12** | Technique & i18n | 2 | Basse | En cours (134 sous-phase 1, 135 sous-phases 1 + 2a + 3a + 3b + 3c + 3e.a + 3e.b.a + 3e.b.b + 3e.b.b.suite + 3e.c.d.quest + 3e.c.d.quest.b + 3e.c.d.quest.c + 3e.c.d.quest.d + 3e.c.d.quest.e) |
