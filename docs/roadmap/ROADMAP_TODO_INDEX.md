...
| **Plan Donjons (DON-01→06)** | **DON-01a livre** | **En cours (2026-08-02)** — front actuel ; DON-02 croise ARC (sequencement a arbitrer) |
| Plan Archetypes (ARC-01→19) | 0/19 | A ouvrir — prerequis externes (MAT-01/03, BES-01) livres |
| Plan Metiers (MET-01→11) | 0/11 | A ouvrir, apres ou avec ARC — MET-01 (valeur marchande de la purete) est bloquant |
