...
> Derniere mise a jour : 2026-04-28 (130 sous-phase 6 — catalogue UI public des montures via `/game/mounts`, premiere vue exposant l'entite `Mount` aux joueurs)
