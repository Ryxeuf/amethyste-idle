...
| Plan Archetypes (ARC-01→19) | 2/19 (+ ARC-02a) | **Ouvert le 2026-08-03** — ARC-01 (la fonction, 3e axe) et **ARC-10** (plafond global supprime) livres. Suite du noyau : **ARC-02b** (techniques + typage plaque/cuir), ARC-03, ARC-11 |
...
> melee attend ARC-02) → **ARC ouvert le 2026-08-03 (ARC-01 livre)**, front actuel.
