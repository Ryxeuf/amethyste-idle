...
> Derniere mise a jour : 2026-04-24 (AVT-30 — Gestion cote client des updates Mercure avatar : abonnement `map/avatar` + invalidation LRU + recomposition temps reel)
...
| **Sprint 12** | Technique & i18n | 2 | Basse | En cours (134 sous-phase 1, 135 sous-phases 1 + 2a + 3a + 3b + 3c + 3c.b + 3c.c + 3c.d + 3e.a + 3e.b.a + 3e.b.b + 3e.b.b.suite + 3e.c.d.quest + 3e.c.d.quest.b + 3e.c.d.quest.c + 3e.c.d.quest.d + 3e.c.d.quest.e + 3e.c.d.quest.f + 3e.c.d.quest.g + 3e.c.d.quest.h + 3e.c.d.quest.i + 3e.c.d.quest.j) |
