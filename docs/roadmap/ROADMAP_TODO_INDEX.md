...
> Derniere mise a jour : 2026-04-28 (135 sous-phase 3e.s — i18n des pages de selection / limite de personnages `character/{select,limit_reached}.html.twig` : 6 cles `game.character.*` FR/EN, paragraphe avec parametres `%count%` + `%plural%`)
