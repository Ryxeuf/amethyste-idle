...
| 15 | **ONB-01 → 04** ◐ | Le compte peut naitre ([PLAN_ONBOARDING.md](PLAN_ONBOARDING.md), Piste A) | **ONB-01 et ONB-03 livres le 2026-07-29** (`/register` existe, `isBanned` est lu, la connexion mene la ou le joueur en est). Restent **ONB-02** (mailer + mot de passe oublie — decision d'infrastructure a prendre : fournisseur d'e-mail, domaine d'envoi, DNS) et **ONB-04** (verification differee, ← ONB-02). **Perdre son mot de passe fait toujours perdre son compte** — dernier bloquant dur d'une ouverture a de vrais joueurs |
