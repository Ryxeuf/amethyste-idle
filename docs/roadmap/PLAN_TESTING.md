...
- **Sous-tache A** — `FightFlowIntegrationTest.php` : ✅
  ...
  - [x] `testLootAfterVictory` : victoire → loot genere, bestiary mis a jour
  - [x] `testMobActionDamagesPlayer` : mob attaque → HP joueur diminuent
  - [x] `testFullCombatFlowToVictory` : combat complet bout en bout
