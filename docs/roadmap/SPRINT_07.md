...
> **6 taches** (4 livrees) | Priorite : **Critique** | Origine : Pivot PBBG ([docs/PIVOT_PBBG.md](../PIVOT_PBBG.md))
...
> Avancement : ZON-02 a ZON-05 ✅ (2026-07-24, voir `ROADMAP_DONE.md`)
...
> ZON-02 (entites Zone & ZoneConnection + seed World 1), ZON-03 (Player.currentZone + PlayerZoneSynchronizer + backfill + CLAUDE.md §7), ZON-04 (zone sur Mob/Pnj/ObjectLayer + WorldEntityZoneListener + `app:zone:audit`) et ZON-05 (ecran `/game/zone` : identite, actions conditionnees, connexions, joueurs presents, points d'interet) livrees le 2026-07-24 — retirees du sprint, voir `ROADMAP_DONE.md`.
