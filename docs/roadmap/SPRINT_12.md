...
> Prerequis : ∅
> Avancement : sous-phases 1 (selecteur de langue securise), 2a (parite UI FR/EN atteinte), 3a (infrastructure multilingue des noms d'items), 3b (cablage du filter Twig `localized_name` dans les templates shop/inventaire/bestiaire) et 3e.a (infrastructure multilingue des noms de monstres) livrees.
