...
- [x] Clic sur une entite existante → panneau lateral affiche ses proprietes editables (bouton ✎ + menu contextuel "Editer")
...
- [x] Modification du level, monstre, nom, coordonnees destination (pour portails), outil requis, respawn delay
