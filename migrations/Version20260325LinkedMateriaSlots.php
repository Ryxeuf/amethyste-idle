...
final class Version20260325LinkedMateriaSlots extends AbstractMigration
{
    ...
    {
        return 'Add linked_slot_id column to slot table for materia synergy';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('ALTER TABLE slot ADD COLUMN IF NOT EXISTS linked_slot_id INT DEFAULT NULL');
