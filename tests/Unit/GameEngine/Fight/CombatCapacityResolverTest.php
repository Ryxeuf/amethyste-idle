...
class CombatCapacityResolverTest extends TestCase
{
    ...
    private LinkedMateriaResolver&MockObject $linkedMateriaResolver;
    ...
    protected function setUp(): void
    {
        ...
        $this->linkedMateriaResolver = $this->createMock(LinkedMateriaResolver::class);
        // By default, no linked bonus
        $this->linkedMateriaResolver->method('hasLinkedBonus')->willReturn(false);
        $this->resolver = new CombatCapacityResolver($this->combatSkillResolver, $this->linkedMateriaResolver);
    }
    ...
    public function testLockedSpellWhenSkillMissing(): void
    {
        ...
        $resolver = new CombatCapacityResolver($combatSkillResolver, $this->linkedMateriaResolver);
